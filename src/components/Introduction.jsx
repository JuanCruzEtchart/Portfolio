...
function Introduction() {
  return (
    <div className="Introduction max-w-[1000px] flex flex-col justify-center w-screen min-h-screen h-screen xl:px-[150px]">
      <h1 className="text-lg text-detail">Hola! Mi nombre es</h1>
      <div className="text-7xl text-white mb-[28px] overflow-hidden">Juan Cruz Etchart.</div>
